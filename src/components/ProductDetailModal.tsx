              ...
              <div className="p-8">
                ...
                <div className="flex flex-col sm:flex-row gap-3 pt-6 border-t border-slate-100">
                  ...
                  <a
                    ...
                    className="btn-secondary flex-1 flex items-center justify-center gap-2 transform hover:scale-[1.02] active:scale-100 transition-all hover:bg-emerald-600 hover:text-white hover:border-emerald-600"
                  >
