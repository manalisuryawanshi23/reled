    ...
    <div className="space-y-2">
      ...
      <div className="flex border border-slate-200 rounded-lg overflow-hidden">
        <button
          ...
          className={`flex-1 flex items-center justify-center gap-1.5 py-2 text-xs font-semibold transition-colors ${
            tab === 'upload' ? 'bg-amber-500 text-white' : 'bg-slate-50 text-slate-500 hover:bg-slate-100'
          }`}
        >
        ...
        <button
          ...
          onClick={() => setTab('url')}
          className={`flex-1 flex items-center justify-center gap-1.5 py-2 text-xs font-semibold transition-colors ${
            tab === 'url' ? 'bg-amber-500 text-white' : 'bg-slate-50 text-slate-500 hover:bg-slate-100'
          }`}
        >
      ...
      {tab === 'upload' && (
        <div
          ...
          className="relative border-2 border-dashed border-slate-200 rounded-xl p-6 text-center cursor-pointer hover:border-amber-400 hover:bg-amber-50/30 transition-all group"
        >
          <input
            ref={fileInputRef}
            type="file"
          ...
          {uploading ? (
            ...
            <div className="flex flex-col items-center gap-2">
              <div className="w-10 h-10 bg-slate-100 group-hover:bg-amber-100 rounded-xl flex items-center justify-center transition-colors">
